...
*/
    ...
    Object.assign ||
      (Object.assign = function(a, b) {
        for (var c = [].slice.call(arguments, 1), d = 0, e; d < c.length; d++)
          if ((e = c[d]))
            for (
              var f = a, m = e, q = Object.getOwnPropertyNames(m), x = 0;
              x < q.length;
              x++
            )
              (e = q[x]), (f[e] = m[e]);
  ...
  (function() {
    ...
    var f = Node.prototype.cloneNode,
      ...
      U = Element.prototype.querySelectorAll,
      ua = Document.prototype.querySelectorAll,
      lb = DocumentFragment.prototype.querySelectorAll,
      mb = (function() {
        if (!c) {
    ...
    if (c) {
      ...
      var ha = document.head;
      ha.insertBefore(V, ha.firstElementChild);
      a.prototype = Object.create(HTMLElement.prototype);
      var va = !document.createElement("div").hasOwnProperty("innerHTML");
      a.G = function(b) {
        if (
          !b.content &&
            ...
            set: function(b) {
              ...
              if (c)
                for (var d = 0; d < c.length; d++)
                  b = "<" + c[d] + ">" + b + "</" + c[d] + ">";
              S.body.innerHTML = b;
              for (a.C(S); this.content.firstChild; )
      ...
      a.C = function(c) {
        c = b(c, "template");
        for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) a.G(f);
      };
      ...
      var We = V(
        ...
        nb = function(a, b) {
          ...
          for (
            var c = "", d = b ? b(a) : M.get.call(a), e = 0, f = d.length, g;
            e < f && (g = d[e]);
            e++
          ) {
            a: {
              ...
              switch (h.nodeType) {
                case Node.ELEMENT_NODE:
                  for (
                    var P = h.localName, m = "<" + P, W = h.attributes, q = 0;
                    (k = W[q]);
                    q++
                  )
                    m += " " + k.name + '="' + k.value.replace(Ve, zc) + '"';
                  m += ">";
                  h = We[P] ? m : m + nb(h, l) + "</" + P + ">";
                  break a;
                case Node.TEXT_NODE:
                  h = h.data;
                  h = k && Xe[k.localName] ? h : h.replace(yc, zc);
                  break a;
    ...
    if (c || mb) {
      a.a = function(a, b) {
        ...
        this.G && this.G(c);
        b &&
          (l.call(c.content, f.call(a.content, !0)), ob(c.content, a.content));
        return c;
      };
      var ob = function(c, d) {
          if (d.querySelectorAll && ((d = b(d, "template")), 0 !== d.length)) {
            ...
            for (var e = 0, f = c.length, g, h; e < f; e++)
              (h = d[e]),
                (g = c[e]),
                a && a.G && a.G(h),
                m.call(g.parentNode, Ye.call(h, !0), g);
          }
        },
        Ye = (Node.prototype.cloneNode = function(b) {
          if (!e && d && this instanceof DocumentFragment)
            if (b) var c = Ze.call(this.ownerDocument, this, !0);
        ...
        Ze = (Document.prototype.importNode = function(c, d) {
          d = d || !1;
          ...
          if (d) {
            ...
            for (var f, k = 0; k < c.length; k++) {
              ...
              for (var l = f.attributes, P = 0, W; P < l.length; P++)
                (W = l[P]), d.setAttribute(W.name, W.value);
  ...
  function oa(a, b) {
    ...
    0 === a.u
      ...
      : ((a.ma = !0),
        pa(function() {
          var c = 1 === a.u ? b.Na : b.Oa;
          if (null === c) (1 === a.u ? qa : ra)(b.ga, a.h);
          else {
            try {
              var d = c(a.h);
            } catch (e) {
      ...
      pa(function() {
        a.ma ||
          ("undefined" !== typeof console &&
            console &&
            console.warn("Possible Unhandled Promise Rejection:", a.h));
      });
    for (var b = 0, c = a.I.length; b < c; b++) oa(a, a.I[b]);
    a.I = null;
  }
  function ta(a, b, c) {
    this.Na = "function" === typeof a ? a : null;
    this.Oa = "function" === typeof b ? b : null;
    this.ga = c;
  }
  function na(a, b) {
    var c = !1;
  ...
  r.prototype.then = function(a, b) {
    var c = new this.constructor(la);
    oa(this, new ta(a, b, c));
    return c;
  };
...
*/
  if (!window.Promise) {
    ...
    new MutationObserver(function() {
      for (var a = Ba.length, b = 0; b < a; b++) Ba[b]();
      Ba.splice(0, a);
    }).observe(Aa, { characterData: !0 });
    pa = function(a) {
      Ba.push(a);
      Aa.textContent = 0 < Aa.textContent.length ? "" : "a";
    };
  }
  (function(a) {
    function b(a, b) {
    ...
    function g(a, b) {
      if (a.__loaded) b && b();
        ...
        (ha && "style" === a.localName) || a.addEventListener("error", c);
      }
    }
    function h(a) {
      return (
    ...
    function m(a, b) {
      return a.childNodes.length ? a.querySelectorAll(b) : U;
    }
    function q(a, b, c) {
      var d = a ? a.length : 0,
        e = c ? -1 : 1;
    ...
    var lb = /(url\()([^)]*)(\))/g,
      ...
      C = {
        Ea: function(a, b) {
          a.href && a.setAttribute("href", C.X(a.getAttribute("href"), b));
          a.src && a.setAttribute("src", C.X(a.getAttribute("src"), b));
          if ("style" === a.localName) {
            var c = C.qa(a.textContent, b, lb);
            a.textContent = C.qa(c, b, mb);
          }
        },
        qa: function(a, b, c) {
        ...
        X: function(a, b) {
          if (void 0 === C.aa) {
            ...
            try {
              ...
              c.pathname = "c%20d";
              C.aa = "http://a/c%20d" === c.href;
            } catch (yc) {}
          }
          if (C.aa) return new URL(a, b).href;
          c = C.xa;
          c ||
            ((c = document.implementation.createHTMLDocument("temp")),
            (C.xa = c),
            (c.ja = c.createElement("base")),
            c.head.appendChild(c.ja),
            (c.ia = c.createElement("a")));
          c.ja.href = b;
          c.ia.href = a;
          return c.ia.href || a;
        }
    ...
    k.prototype.Ka = function(a, b) {
      ...
      if ((c = a.querySelector("base")))
        (b = C.X(c.getAttribute("href"), b)), c.removeAttribute("href");
      c = m(
        a,
    ...
    k.prototype.Ja = function(a) {
      var b = this;
      q(a, function(a) {
        return q(a.addedNodes, function(a) {
          a &&
            a.nodeType === Node.ELEMENT_NODE &&
            (h(a) ? b.g(a) : b.loadImports(a));
        });
      });
    };
    var va = null;
...
*/
  ...
  var Ca = document.querySelector('script[src*="webcomponents-lite.js"]'),
    Da = /wc-(.+)/,
    t = {};
  if (!t.noOpts) {
    location.search
      ...
      .forEach(function(a) {
        a = a.split("=");
        var b;
        a[0] && (b = a[0].match(Da)) && (t[b[1]] = a[1] || !0);
      });
    if (Ca)
      for (var Ea = 0, Fa = void 0; (Fa = Ca.attributes[Ea]); Ea++)
        "src" !== Fa.name && (t[Fa.name] = Fa.value || !0);
  ...
  var Ha = t.shadydom;
  Ha &&
    ((window.ShadyDOM = window.ShadyDOM || {}), (window.ShadyDOM.force = Ha));
  var Ia = t.register || t.ce;
  Ia &&
    window.customElements &&
    (window.customElements.forcePolyfill = Ia); /*
Copyright (c) 2016 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
The complete set of contributors may be found at http://polymer.github.io/CONTRIBUTORS.txt
...
*/
  function Ja() {
    this.pa = this.root = null;
    this.T = !1;
    this.D = this.P = this.ca = this.assignedSlot = this.assignedNodes = this.H = null;
    this.childNodes = this.nextSibling = this.previousSibling = this.lastChild = this.firstChild = this.parentNode = this.K = void 0;
    this.ka = this.la = !1;
    this.O = {};
  }
  ...
  w.Ga = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);
  var Ka = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");
  w.m = !!(Ka && Ka.configurable && Ka.get);
  w.ea = w.force || !w.Ga;
  w.J = w.noPatch || !1;
  w.oa = w.preferPerformance;
  function y(a) {
    return (a = v(a)) && void 0 !== a.firstChild;
  }
  function z(a) {
    return "ShadyRoot" === a.za;
  }
  function La(a) {
    return (a = (a = v(a)) && a.root) && Ma(a);
  }
  ...
  function cb(a) {
    var b = a && a.F;
    b && (b.S.delete(a.ya), b.S.size || (u(a.Aa).H = null));
  }
  function db(a, b) {
    var c = b.getRootNode();
    return a
    ...
    for (
      ...
      a: {
        ...
        switch (h.nodeType) {
          case Node.ELEMENT_NODE:
            k = h.localName;
            for (var m = "<" + k, q = h.attributes, x = 0, M; (M = q[x]); x++)
              m += " " + M.name + '="' + M.value.replace(eb, gb) + '"';
            m += ">";
            h = ib[k] ? m : m + kb(h, l) + "</" + k + ">";
            break a;
          case Node.TEXT_NODE:
            h = h.data;
            h = k && jb[k.localName] ? h : h.replace(fb, gb);
            break a;
          case Node.COMMENT_NODE:
            h = "\x3c!--" + h.data + "--\x3e";
            break a;
  ...
  function D(a, b) {
    ...
    for (var c = 0; c < b.length; c++) {
      ...
      e &&
        ...
        e.value ? qb[d] || (qb[d] = e.value) : sb(d));
    }
  }
  var E = document.createTreeWalker(document, NodeFilter.SHOW_ALL, null, !1),
    F = document.createTreeWalker(document, NodeFilter.SHOW_ELEMENT, null, !1),
  ...
  var wb = [
    ...
    xb = ["querySelector", "querySelectorAll"];
  function yb() {
    var a = ["dispatchEvent", "addEventListener", "removeEventListener"];
    window.EventTarget
      ? D(window.EventTarget.prototype, a)
      : (D(Node.prototype, a), D(Window.prototype, a));
    pb
      ? D(
          Node.prototype,
    ...
    a = {
      ...
      children: {
        get: function() {
          var a = [];
          F.currentNode = this;
          for (var c = F.firstChild(); c; ) a.push(c), (c = F.nextSibling());
          return Va(a);
        }
      },
      childElementCount: {
    ...
    pb
      ? (D(Element.prototype, wb),
        ...
        Object.getOwnPropertyDescriptor(HTMLElement.prototype, "children") &&
          D(HTMLElement.prototype, ["children"]),
        Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML") &&
          D(HTMLElement.prototype, ["innerHTML"]))
      : (tb(Element.prototype, a),
        tb(Element.prototype, {
          previousElementSibling: {
            get: function() {
              F.currentNode = this;
          ...
          innerHTML: {
            ...
            set: function(a) {
              ...
              d =
                this.namespaceURI && this.namespaceURI !== ub.namespaceURI
                  ? ub.createElementNS(this.namespaceURI, d)
                  : ub.createElement(d);
              d.innerHTML = a;
              for (
    ...
    D(Element.prototype, xb);
    D(HTMLElement.prototype, ["focus", "blur", "contains"]);
    pb && D(HTMLElement.prototype, ["parentElement", "children", "innerHTML"]);
    window.HTMLTemplateElement &&
      D(window.HTMLTemplateElement.prototype, ["innerHTML"]);
    pb ? D(DocumentFragment.prototype, wb) : tb(DocumentFragment.prototype, a);
    D(DocumentFragment.prototype, xb);
    pb
      ? (D(Document.prototype, wb), D(Document.prototype, ["activeElement"]))
      : tb(Document.prototype, a);
    D(Document.prototype, ["importNode", "getElementById"]);
    D(Document.prototype, xb);
  }
  var zb = B({
      get childNodes() {
    ...
    Bb;
  for (Bb in zb) zb[Bb].enumerable = !1;
  for (var Cb in Ab) Ab[Cb].enumerable = !1;
  var Db = w.m || w.J,
    Eb = Db
      ? function() {}
      : function(a) {
  ...
  var Gb = "__eventWrappers" + Date.now(),
    Hb = (function() {
  ...
  function Mb(a) {
    a.__composedPath || (a.__composedPath = Lb(a.target, !0));
    ...
    if (b) {
      ...
      if ("function" === d || "object" === d)
        if (
          ...
          if (Jb[a]) return this.__shady_native_addEventListener(a, b, c);
          ...
          k = function(e) {
            ...
            if (!z(h) || -1 != e.composedPath().indexOf(h))
              if (e.composed || -1 < e.composedPath().indexOf(h))
                if (Qb(e) && e.target === e.relatedTarget)
  ...
  function Wb(a, b, c) {
    if (b) {
      if (Jb[a]) return this.__shady_native_removeEventListener(a, b, c);
      if (c && "object" === typeof c) {
        var d = !!c.capture;
        var e = !!c.once;
        var f = !!c.passive;
      ...
      k &&
        ((e = Tb(k, g, a, d, e, f)),
        -1 < e && ((h = k.splice(e, 1)[0].Ya), k.length || (b[Gb] = void 0)));
  ...
  var Yb = B({
    get composed() {
      void 0 === this.__composed &&
        (Hb
          ? (this.__composed =
              "focusin" === this.type || "focusout" === this.type || Hb(this))
          : !1 !== this.isTrusted && (this.__composed = Ib[this.type]));
      return this.__composed || !1;
    },
    composedPath: function() {
      this.__composedPath ||
        (this.__composedPath = Lb(this.__target, this.composed));
    ...
    get relatedTarget() {
      ...
      this.__relatedTargetComposedPath ||
        (this.__relatedTargetComposedPath = Lb(this.__relatedTarget, !0));
      return Nb(
        this.currentTarget || this.__previousCurrentTarget,
        this.__relatedTargetComposedPath
      );
    ...
    stopImmediatePropagation: function() {
      ...
      this.Z = this.__immediatePropagationStopped = !0;
    }
  });
  function Vb(a) {
    a.__target = a.target;
  ...
  var Zb = Ob(Event),
    ...
    ac = Ob(MouseEvent);
  function bc() {
    if (!Hb && Object.getOwnPropertyDescriptor(Event.prototype, "isTrusted")) {
      var a = function() {
  ...
  function ec(a, b, c, d) {
    ...
    if (b == a.length && d == c.length) {
      h = a.length;
      for (var l = c.length, m = 0; m < k - g && fc(a[--h], c[--l]); ) m++;
      h = m;
    }
    e += g;
    f += g;
    ...
    if (e == b) {
      for (b = dc(e, 0); f < d; ) b.L.push(c[f++]);
      return [b];
    }
    if (f == d) return [dc(e, b - e)];
    k = e;
    g = f;
    d = d - g + 1;
    h = b - k + 1;
  ...
  function hc(a, b, c) {
    ...
    if (a.nodeType === Node.DOCUMENT_FRAGMENT_NODE) {
      ...
      for (var e = 0; e < d.length; e++) gc(d[e], b, c);
      a = u(a);
  ...
  function oc(a, b) {
    if (a) {
      ...
      for (var c = 0, d; c < a.length; c++)
        (d = a[c]), d.nodeType === Node.ELEMENT_NODE && oc(d, b);
    }
  }
  ...
  function vc(a) {
    ...
    a &&
      "slot" === a.localName &&
      (b =
        (b = (b = v(a)) && b.D) && b.length ? b[0] : vc(a.__shady_nextSibling));
    return b;
  }
  function wc(a, b, c) {
    if ((a = (a = v(a)) && a.H))
      b && a.addedNodes.push(b), c && a.removedNodes.push(c), ab(a);
  }
  var Cc = B({
    get parentNode() {
      var a = v(this);
    ...
    get isConnected() {
      ...
      for (a = this; a && !(a instanceof Document); )
        a = a.__shady_parentNode || (z(a) ? a.host : void 0);
    ...
    insertBefore: function(a, b) {
      if (this.ownerDocument !== pc && a.ownerDocument !== pc)
      ...
      if (b === a) return a;
      var d = [],
        e = (c = xc(this)) ? c.host.localName : nc(this),
        f = a.__shady_parentNode;
      if (f) {
        var g = nc(a);
        f.__shady_removeChild(a, !!c || !xc(a));
      }
      f = !0;
      var h = (!qc || void 0 === a.__noInsertionPoint) && !mc(a, e),
        k =
          ...
          (!qc || a.nodeType === Node.DOCUMENT_FRAGMENT_NODE);
      if (k || h)
        h && (g = g || nc(a)),
          oc(a, function(a) {
            ...
            if (h) {
              var b = g;
              G() && (b && lc(a, b), (b = G()) && b.scopeNode(a, e));
            }
          });
      ...
      y(this) &&
        (hc(a, this, b),
        (c = v(this)),
        La(this) ? (Ac(c.root), (f = !1)) : c.root && (f = !1));
      f
        ? ((c = z(this) ? this.host : this),
          b
            ? ((b = vc(b)), c.__shady_native_insertBefore(a, b))
    ...
    removeChild: function(a, b) {
      ...
      uc(a);
      c &&
        ((b = this && "slot" === this.localName) && (f = !0),
        (d || b) && Ac(c));
      f ||
        ((f = z(this) ? this.host : this),
    ...
    for (var e = 0, f = a.length, g = void 0; e < f && (g = a[e]); e++) {
      ...
      if ((h = g.nodeType === Node.ELEMENT_NODE)) {
        ...
        var k = b,
          ...
          q = k(h);
        q && m.push(h);
        l && l(q) ? (h = q) : (Ec(h.__shady_childNodes, k, l, m), (h = void 0));
      }
      if (h) break;
    }
  }
  ...
  var Jc = B({
    get activeElement() {
      ...
      if (
        ...
        return null;
      for (b = xc(a); b && b !== this; ) (a = b.host), (b = xc(a));
  ...
  var Kc = document.implementation.createHTMLDocument("inert"),
    Lc = B({
      get innerHTML() {
        return y(this)
          ? kb("template" === this.localName ? this.content : this, function(
              a
            ) {
      ...
      set innerHTML(a) {
        if ("template" === this.localName) this.__shady_native_innerHTML = a;
          ...
          b =
            this.namespaceURI && this.namespaceURI !== Kc.namespaceURI
              ? Kc.createElementNS(this.namespaceURI, b)
              : Kc.createElement(b);
          for (
            w.m ? (b.__shady_native_innerHTML = a) : (b.innerHTML = a);
  ...
  function Nc(a, b) {
    ...
    A(a, Lc, b);
    A(a, Fc, b);
    w.J && !b ? (A(a, Cc, b), A(a, Ic, b)) : w.m || (A(a, Ab), A(a, zb));
  }
  var Oc = {},
    Pc = w.deferConnectionCallbacks && "loading" === document.readyState,
    Qc;
  function Rc(a) {
    var b = [];
    do b.unshift(a);
  ...
  function Sc(a, b, c) {
    if (a !== Oc) throw new TypeError("Illegal constructor");
    this.za = "ShadyRoot";
    this.host = b;
    this.mode = c && c.mode;
    jc(b);
    a = u(b);
    a.root = this;
    a.pa = "closed" !== this.mode ? this : null;
    a = u(this);
    ...
    if ((b = a.B)) {
      for (var c; a; )
        a: {
          ...
          if (z(a) && (b = v(b.host)) && 0 < b.N) break a;
          a = void 0;
        }
      b = c;
    }
  ...
  Sc.prototype._renderSelf = function() {
    ...
    if (this.a) {
      ...
      for (b = 0; b < this.a.length; b++) {
        ...
        if (!e.assignedNodes.length)
          for (d = c.__shady_firstChild; d; d = d.__shady_nextSibling)
            Vc(this, d, c);
        (d = (d = v(c.__shady_parentNode)) && d.root) &&
          (Ma(d) || d.B) &&
          d._renderSelf();
        Wc(this, e.D, e.assignedNodes);
        if ((d = e.ca)) {
          for (f = 0; f < d.length; f++) v(d[f]).P = null;
          e.ca = null;
          d.length > e.assignedNodes.length && (e.T = !0);
        }
        e.T && ((e.T = !1), Xc(this, c));
      }
      c = this.a;
      ...
      for (c = 0; c < b.length; c++) {
        ...
        g = ec(d, d.length, f, f.length);
        k = h = 0;
        for (var l = void 0; h < g.length && (l = g[h]); h++) {
          for (var m = 0, q = void 0; m < l.L.length && (q = l.L[m]); m++)
        ...
        for (l = void 0; k < g.length && (l = g[k]); k++)
          for (h = f[l.index], m = l.index; m < l.index + l.R; m++)
            (q = d[m]), e.__shady_native_insertBefore(q, h), f.splice(m, 0, q);
      }
    }
    if (!w.preferPerformance && !this.ba)
  ...
  function Vc(a, b, c) {
    ...
    e !== d.assignedSlot && d.assignedSlot && (u(d.assignedSlot).T = !0);
  }
  function Wc(a, b, c) {
  ...
  function Xc(a, b) {
    ...
    b = v(b);
    b.assignedSlot && Xc(a, b.assignedSlot);
  }
  function Uc(a) {
    if (a.c && a.c.length) {
      ...
      if (c) for (var g in c) a.b[g] = Zc(a.b[g]);
      a.c = [];
    }
  }
  function Yc(a) {
  ...
  function Zc(a) {
    return a.sort(function(a, c) {
      a = Rc(a);
      for (var b = Rc(c), e = 0; e < a.length; e++) {
        c = a[e];
        var f = b[e];
        if (c !== f)
          return (
      ...
      for (d in c)
        for (var e = c[d], f = 0; f < e.length; f++) {
          ...
          if (Ua(b, g)) {
            ...
            var h = a.a.indexOf(g);
            0 <= h &&
              (a.a.splice(h, 1), (h = v(g.__shady_parentNode)) && h.N && h.N--);
            f--;
            g = v(g);
            if ((h = g.D))
  ...
  if (window.customElements && w.ea && !w.preferPerformance) {
    var $c = new Map();
    Qc = function() {
      var a = [];
    ...
    var ad = function(a, b, c) {
        var d = 0,
          e = "__isConnected" + d++;
        if (b || c)
          (a.prototype.connectedCallback = a.prototype.ua = function() {
            Pc
              ? $c.set(this, !0)
              : this[e] || ((this[e] = !0), b && b.call(this));
          }),
            (a.prototype.disconnectedCallback = a.prototype.va = function() {
              Pc
                ? this.isConnected || $c.set(this, !1)
    ...
    Object.defineProperty(window.CustomElementRegistry.prototype, "define", {
      value: function(a, b) {
        ...
        bd.call(window.customElements, a, ad(b, c, d));
  ...
  p.Object.defineProperties(cd.prototype, {
    activeElement: {
      ...
      enumerable: !0,
      get: function() {
        if (z(this.node) || this.node.nodeType === Node.DOCUMENT_NODE)
    ...
    host: {
      ...
      enumerable: !0,
      get: function() {
        if (z(this.node)) return this.node.host;
      }
    },
    parentNode: {
      configurable: !0,
  ...
  cc.forEach(function(a) {
    Object.defineProperty(cd.prototype, a, {
      get: function() {
  ...
  var dd = new WeakMap();
  function ed(a) {
    if (z(a) || a instanceof cd) return a;
    var b = dd.get(a);
    b || ((b = new cd(a)), dd.set(a, b));
    return b;
  }
  var fd = B({
  ...
  var gd = B({
    get assignedSlot() {
      ...
      (a = a && a.__shady_shadowRoot) && Tc(a);
      return ((a = v(this)) && a.assignedSlot) || null;
    }
  });
  var hd = window.document;
  function id(a, b) {
    if ("slot" === b) (a = a.__shady_parentNode), La(a) && Ac(v(a).root);
    else if ("slot" === a.localName && "name" === b && (b = xc(a))) {
      if (b.a) {
        Uc(b);
        var c = a.wa,
          d = Yc(a);
  ...
  var jd = B({
    ...
    setAttribute: function(a, b) {
      if (this.ownerDocument !== hd) this.__shady_native_setAttribute(a, b);
      else {
        var c;
        (c = G()) && "class" === a
          ? (c.setElementClass(this, b), (c = !0))
          : (c = !1);
        c || (this.__shady_native_setAttribute(a, b), id(this, a));
      }
    },
  ...
  cc.forEach(function(a) {
    kd[a] = {
      set: function(b) {
        var c = u(this),
          d = a.substring(2);
        c.O[a] && this.removeEventListener(d, c.O[a]);
  ...
  var md = window.document,
    nd = B({
      importNode: function(a, b) {
        if (a.ownerDocument !== md || "template" === a.localName)
  ...
  var od = B({
    addEventListener: Ub.bind(window),
    removeEventListener: Wb.bind(window)
  });
  var pd = {};
  Object.getOwnPropertyDescriptor(HTMLElement.prototype, "parentElement") &&
    (pd.parentElement = Cc.parentElement);
  Object.getOwnPropertyDescriptor(HTMLElement.prototype, "contains") &&
    (pd.contains = Cc.contains);
  Object.getOwnPropertyDescriptor(HTMLElement.prototype, "children") &&
    (pd.children = Fc.children);
  Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML") &&
    (pd.innerHTML = Lc.innerHTML);
  Object.getOwnPropertyDescriptor(HTMLElement.prototype, "className") &&
    (pd.className = jd.className);
  var qd = {
      EventTarget: [fd],
      Node: [Cc, window.EventTarget ? null : fd],
      Text: [gd],
      Element: [
        jd,
        Fc,
        gd,
        !w.m || "innerHTML" in Element.prototype ? Lc : null,
        window.HTMLSlotElement ? null : ld
      ],
      HTMLElement: [kd, pd],
      HTMLSlotElement: [ld],
      DocumentFragment: [Hc, Ic],
      Document: [nd, Hc, Ic, Jc],
      Window: [od]
    },
    rd = w.m ? null : ["innerHTML", "textContent"];
  function sd(a) {
    var b = a ? null : rd,
      c = {},
      d;
    for (d in qd)
      (c.W = window[d] && window[d].prototype),
        qd[d].forEach(
          (function(c) {
            return function(d) {
              return c.W && d && A(c.W, d, a, b);
            };
          })(c)
        ),
        (c = { W: c.W });
  ...
  if (w.ea) {
    ...
    yb();
    sd("__shady_");
    Object.defineProperty(document, "_activeElement", Jc.activeElement);
    A(Window.prototype, od, "__shady_");
    w.J || (sd(), bc());
    Xb();
    window.Event = Zb;
    window.CustomEvent = $b;
    window.MouseEvent = ac;
    window.ShadowRoot = Sc;
  }
  var td = new Set(
      ...
      if (d.nodeType === Node.ELEMENT_NODE) {
        ...
        if ("link" === f && "import" === e.getAttribute("rel")) {
          ...
          if (d instanceof Node && !c.has(d))
            for (c.add(d), d = d.firstChild; d; d = d.nextSibling) wd(d, b, c);
          d = vd(a, e);
          continue;
        } else if ("template" === f) {
          d = vd(a, e);
        ...
        if ((e = e.__CE_shadowRoot))
          for (e = e.firstChild; e; e = e.nextSibling) wd(e, b, c);
      }
      d = d.firstChild ? d.firstChild : vd(a, d);
    }
  }
  function I(a, b, c) {
    a[b] = c;
  ...
  function J(a, b) {
    ...
    for (b = 0; b < c.length; b++) {
      var d = c[b];
      1 === d.__CE_state ? a.connectedCallback(d) : Bd(a, d);
    }
  }
  function K(a, b) {
    var c = [];
  ...
  xd.prototype.connectedCallback = function(a) {
    var b = a.__CE_definition;
    b.connectedCallback && b.connectedCallback.call(a);
  };
  xd.prototype.disconnectedCallback = function(a) {
    var b = a.__CE_definition;
    b.disconnectedCallback && b.disconnectedCallback.call(a);
  };
  xd.prototype.attributeChangedCallback = function(a, b, c, d, e) {
  ...
  function Cd(a) {
    ...
    "loading" === this.a.readyState &&
      ...
      this.F.observe(this.a, { childList: !0, subtree: !0 }));
  }
  function Dd(a) {
    a.F && a.F.disconnect();
  }
  Cd.prototype.c = function(a) {
    ...
    ("interactive" !== b && "complete" !== b) || Dd(this);
    for (b = 0; b < a.length; b++)
      for (var c = a[b].addedNodes, d = 0; d < c.length; d++) L(this.b, c[d]);
  };
  function Ed() {
    var a = this;
  ...
  Ed.prototype.resolve = function(a) {
    if (this.h) throw Error("Already resolved.");
    this.h = a;
    this.a && this.a(a);
  };
  function N(a) {
  ...
  function Fd(a) {
    if (!1 !== a.b) {
      a.b = !1;
      for (var b = a.g, c = [], d = new Map(), e = 0; e < b.length; e++)
        d.set(b[e].localName, []);
      L(a.a, document, {
        Y: function(b) {
          if (void 0 === b.__CE_state) {
      ...
      for (e = 0; e < c.length; e++) Bd(a.a, c[e]);
      for (; 0 < b.length; ) {
        var f = b.shift();
        e = f.localName;
        f = d.get(f.localName);
        for (var g = 0; g < f.length; g++) Bd(a.a, f[g]);
        (e = a.l.get(e)) && e.resolve(void 0);
      }
    }
  }
  n.get = function(a) {
  ...
  window.CustomElementRegistry = N;
  N.prototype.define = N.prototype.sa;
  N.prototype.upgrade = N.prototype.Y;
  N.prototype.get = N.prototype.get;
  N.prototype.whenDefined = N.prototype.ta;
  N.prototype.polyfillWrapFlushCallback = N.prototype.Pa;
  var Gd = window.Document.prototype.createElement,
    Hd = window.Document.prototype.createElementNS,
    Id = window.Document.prototype.importNode,
    Jd = window.Document.prototype.prepend,
    Kd = window.Document.prototype.append,
    Ld = window.DocumentFragment.prototype.prepend,
    Md = window.DocumentFragment.prototype.append,
    Nd = window.Node.prototype.cloneNode,
    Od = window.Node.prototype.appendChild,
    Pd = window.Node.prototype.insertBefore,
    Qd = window.Node.prototype.removeChild,
    Rd = window.Node.prototype.replaceChild,
    Sd = Object.getOwnPropertyDescriptor(window.Node.prototype, "textContent"),
    Td = window.Element.prototype.attachShadow,
    Ud = Object.getOwnPropertyDescriptor(window.Element.prototype, "innerHTML"),
    Vd = window.Element.prototype.getAttribute,
    Wd = window.Element.prototype.setAttribute,
    Xd = window.Element.prototype.removeAttribute,
    Yd = window.Element.prototype.getAttributeNS,
    Zd = window.Element.prototype.setAttributeNS,
    $d = window.Element.prototype.removeAttributeNS,
    ae = window.Element.prototype.insertAdjacentElement,
    be = window.Element.prototype.insertAdjacentHTML,
    ce = window.Element.prototype.prepend,
    de = window.Element.prototype.append,
    ee = window.Element.prototype.before,
    fe = window.Element.prototype.after,
    ge = window.Element.prototype.replaceWith,
    he = window.Element.prototype.remove,
    ie = window.HTMLElement,
    je = Object.getOwnPropertyDescriptor(
      window.HTMLElement.prototype,
      "innerHTML"
    ),
    ke = window.HTMLElement.prototype.insertAdjacentElement,
    le = window.HTMLElement.prototype.insertAdjacentHTML;
  var me = new (function() {})();
  function ne() {
    var a = oe;
    window.HTMLElement = (function() {
      function b() {
        ...
        if (0 === e.length)
          return (
            (e = Gd.call(document, d.localName)),
  ...
  function qe() {
    ...
    I(Document.prototype, "importNode", function(b, c) {
      b = Id.call(this, b, !!c);
      this.__CE_hasRegistry ? L(a, b) : Ad(a, b);
      return b;
    });
    ...
    pe(a, Document.prototype, { V: Jd, append: Kd });
  }
  function re() {
    function a(a, d) {
      Object.defineProperty(a, "textContent", {
        ...
        set: function(a) {
          if (this.nodeType === Node.TEXT_NODE) d.set.call(this, a);
            ...
            d.set.call(this, a);
            if (c) for (a = 0; a < c.length; a++) K(b, c[a]);
          }
        }
      });
    }
    var b = oe;
    I(Node.prototype, "insertBefore", function(a, d) {
      if (a instanceof DocumentFragment) {
        var c = Array.prototype.slice.apply(a.childNodes);
        a = Pd.call(this, a, d);
        if (H(this)) for (d = 0; d < c.length; d++) J(b, c[d]);
        return a;
      }
      c = H(a);
      d = Pd.call(this, a, d);
    ...
    I(Node.prototype, "appendChild", function(a) {
      if (a instanceof DocumentFragment) {
        var c = Array.prototype.slice.apply(a.childNodes);
        a = Od.call(this, a);
        if (H(this)) for (var e = 0; e < c.length; e++) J(b, c[e]);
        return a;
      }
      c = H(a);
      e = Od.call(this, a);
    ...
    I(Node.prototype, "cloneNode", function(a) {
      a = Nd.call(this, !!a);
      this.ownerDocument.__CE_hasRegistry ? L(b, a) : Ad(b, a);
      return a;
    });
    I(Node.prototype, "removeChild", function(a) {
      var c = H(a),
        e = Qd.call(this, a);
      c && K(b, a);
      return e;
    });
    I(Node.prototype, "replaceChild", function(a, d) {
      if (a instanceof DocumentFragment) {
        var c = Array.prototype.slice.apply(a.childNodes);
        a = Rd.call(this, a, d);
        if (H(this)) for (K(b, d), d = 0; d < c.length; d++) J(b, c[d]);
        return a;
      }
      c = H(a);
      var f = Rd.call(this, a, d),
        g = H(this);
      g && K(b, d);
      c && K(b, a);
      g && J(b, a);
    ...
    Sd && Sd.get
      ...
      : zd(b, function(b) {
          a(b, {
            ...
            set: function(a) {
              for (; this.firstChild; ) Qd.call(this, this.firstChild);
              Od.call(this, document.createTextNode(a));
            }
          });
        });
  }
    ...
    function b(b) {
      return function(c) {
        ...
        for (var h = [], k = 0; k < d.length; k++) {
          var l = d[k];
          l instanceof Element && H(l) && h.push(l);
          if (l instanceof DocumentFragment)
            for (l = l.firstChild; l; l = l.nextSibling) e.push(l);
          else e.push(l);
        }
        b.apply(this, d);
        for (d = 0; d < h.length; d++) K(a, h[d]);
        if (H(this))
          for (d = 0; d < e.length; d++)
            (h = e[d]), h instanceof Element && J(a, h);
      };
    }
    var c = Element.prototype;
    void 0 !== ee && (c.before = b(ee));
    void 0 !== ee && (c.after = b(fe));
    void 0 !== ge &&
      I(c, "replaceWith", function(b) {
        for (var c = [], d = 0; d < arguments.length; ++d) c[d] = arguments[d];
        d = [];
        for (var g = [], h = 0; h < c.length; h++) {
          var k = c[h];
          k instanceof Element && H(k) && g.push(k);
        ...
        h = H(this);
        ge.apply(this, c);
        for (c = 0; c < g.length; c++) K(a, g[c]);
        if (h)
          for (K(a, this), c = 0; c < d.length; c++)
            (g = d[c]), g instanceof Element && J(a, g);
      });
    void 0 !== he &&
      I(c, "remove", function() {
        var b = H(this);
  ...
  function te() {
    function a(a, b) {
      Object.defineProperty(a, "innerHTML", {
        ...
        set: function(a) {
          ...
          this.ownerDocument.__CE_hasRegistry ? L(d, this) : Ad(d, this);
          return a;
        }
      });
    }
    function b(a, b) {
      I(a, "insertAdjacentElement", function(a, c) {
        var e = H(c);
        a = b.call(this, a, c);
        e && K(d, c);
        H(a) && J(d, c);
    ...
    function c(a, b) {
      function c(a, b) {
        ...
        for (b = 0; b < c.length; b++) L(d, c[b]);
      }
      I(a, "insertAdjacentHTML", function(a, d) {
        a = a.toLowerCase();
        if ("beforebegin" === a) {
    ...
    var d = oe;
    Td &&
      I(Element.prototype, "attachShadow", function(a) {
        return (this.__CE_shadowRoot = a = Td.call(this, a));
      });
    Ud && Ud.get
      ? a(Element.prototype, Ud)
      : je && je.get
      ? a(HTMLElement.prototype, je)
      : zd(d, function(b) {
          a(b, {
            enumerable: !0,
            configurable: !0,
            get: function() {
              return Nd.call(this, !0).innerHTML;
            },
            set: function(a) {
              var b = "template" === this.localName,
                c = b ? this.content : this,
                d = Hd.call(document, this.namespaceURI, this.localName);
              for (d.innerHTML = a; 0 < c.childNodes.length; )
                Qd.call(c, c.childNodes[0]);
              for (a = b ? d.content : d; 0 < a.childNodes.length; )
                Od.call(c, a.childNodes[0]);
            }
          });
        });
    I(Element.prototype, "setAttribute", function(a, b) {
      if (1 !== this.__CE_state) return Wd.call(this, a, b);
      var c = Vd.call(this, a);
      Wd.call(this, a, b);
      b = Vd.call(this, a);
      d.attributeChangedCallback(this, a, c, b, null);
    });
    I(Element.prototype, "setAttributeNS", function(a, b, c) {
      if (1 !== this.__CE_state) return Zd.call(this, a, b, c);
      var e = Yd.call(this, a, b);
      Zd.call(this, a, b, c);
      c = Yd.call(this, a, b);
      d.attributeChangedCallback(this, b, e, c, a);
    });
    I(Element.prototype, "removeAttribute", function(a) {
      if (1 !== this.__CE_state) return Xd.call(this, a);
      var b = Vd.call(this, a);
      Xd.call(this, a);
      null !== b && d.attributeChangedCallback(this, a, b, null, null);
    });
    I(Element.prototype, "removeAttributeNS", function(a, b) {
      if (1 !== this.__CE_state) return $d.call(this, a, b);
      var c = Yd.call(this, a, b);
      $d.call(this, a, b);
      var e = Yd.call(this, a, b);
      c !== e && d.attributeChangedCallback(this, b, c, e, a);
    });
    ke
      ? b(HTMLElement.prototype, ke)
      : ae
      ? b(Element.prototype, ae)
      : console.warn(
          "Custom Elements: `Element#insertAdjacentElement` was not patched."
        );
    le
      ? c(HTMLElement.prototype, le)
      : be
      ? c(Element.prototype, be)
      : console.warn(
          "Custom Elements: `Element#insertAdjacentHTML` was not patched."
        );
    pe(d, Element.prototype, { V: ce, append: de });
    se(d);
  }
  ...
  if (
    !ue ||
    ue.forcePolyfill ||
    "function" != typeof ue.define ||
    "function" != typeof ue.get
  ) {
    var oe = new xd();
    ne();
    qe();
    pe(oe, DocumentFragment.prototype, { V: Ld, append: Md });
    re();
    te();
    document.__CE_hasRegistry = !0;
    var customElements = new N(oe);
    ...
    a.parent &&
      ...
      a.atRule
        ? 0 === c.indexOf("@media")
          ? (a.type = Ce)
          : c.match(De) &&
            ((a.type = Ee), (a.keyframesName = a.selector.split(Be).pop()))
        : (a.type = 0 === c.indexOf("--") ? Fe : Ge));
    if ((c = a.rules))
  ...
  window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
    ...
    : window.ShadyCSS
    ? (Ne(window.ShadyCSS), (window.ShadyCSS = void 0))
    : Ne(window.WebComponents && window.WebComponents.flags);
  var Q = Me,
    Qe = Oe;
  var Re = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
    Se = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,
    Te = /(--[\w-]+)\s*([:,;)]|$)/gi,
    Ue = /(animation\s*:)|(animation-name\s*:)/,
    $e = /@media\s(.*)/,
    af = /\{[^}]*\}/g;
  var bf = new Set();
  function cf(a, b) {
    if (!a) return "";
    "string" === typeof a && (a = we(a));
    b && df(a, b);
    return He(a, Q);
  }
  function ef(a) {
    !a.__cssRules && a.textContent && (a.__cssRules = we(a.textContent));
    return a.__cssRules || null;
  }
  function ff(a) {
    return !!a.parent && a.parent.type === Ee;
  }
  function df(a, b, c, d) {
    if (a) {
      var e = !1,
        f = a.type;
      if (d && f === Ce) {
        var g = a.selector.match($e);
        g && (window.matchMedia(g[1]).matches || (e = !0));
      }
      f === Ge ? b(a) : c && f === Ee ? c(a) : f === Fe && (e = !0);
      if ((a = a.rules) && !e)
  ...
  function kf(a) {
    ...
    var b = document.head;
    b.insertBefore(a, (jf ? jf.nextSibling : null) || b.firstChild);
    return (jf = a);
  }
  function hf(a, b, c) {
    b = b || document.head;
    ...
    jf
      ? a.compareDocumentPosition(jf) === Node.DOCUMENT_POSITION_PRECEDING &&
        (jf = a)
      : (jf = a);
  }
  function lf(a, b) {
  ...
  function sf(a) {
    a = void 0 === a ? "" : a;
    return "" !== a && Q ? (O ? "shadow" === a : "shady" === a) : !1;
  }
  function tf() {}
  function uf(a, b) {
    vf(R, a, function(a) {
  ...
  function vf(a, b, c) {
    ...
    if (d) for (b = 0; b < d.length; b++) vf(a, d[b], c);
  }
  function wf(a, b, c) {
    if (b)
      if (a.classList)
        ...
        c
          ? d && ((b = d.replace("style-scope", "").replace(b, "")), nf(a, b))
          : nf(a, (d ? d + " " : "") + "style-scope " + b);
      }
  }
  function xf(a, b, c) {
    vf(R, a, function(a) {
  ...
  function zf(a, b, c, d, e) {
    ...
    "" === e &&
      (O || "shady" === (void 0 === d ? "" : d)
        ? (e = cf(b, c))
        : ((a = pf(a)), (e = Af(f, b, a.is, a.M, c) + "\n\n")));
    return e.trim();
  }
  function Af(a, b, c, d, e) {
    var f = Bf(c, d);
    c = c ? "." + c : "";
    return cf(b, function(b) {
      b.c || ((b.selector = b.j = Cf(a, b, a.b, c, f)), (b.c = !0));
      e && e(b, c, f);
    });
  }
  function Bf(a, b) {
  ...
  function Df(a) {
    return a.replace(Ef, function(a, c, d) {
      -1 < d.indexOf("+")
        ? (d = d.replace(/\+/g, "___"))
  ...
  tf.prototype.b = function(a, b, c) {
    ...
    a = a.replace(If, ":host $1");
    a = a.replace(Jf, function(a, e, f) {
      d || ((a = Kf(f, e, b, c)), (d = d || a.stop), (e = a.Ca), (f = a.value));
      return e + f;
    });
    f && (a = Hf(a, g));
    e && (a = Df(a));
  ...
  function Kf(a, b, c, d) {
    ...
    if (c) {
      var f = !0;
      c &&
        (a = a.replace(Nf, function(a, b) {
          return " > " + b;
        }));
    }
    a = a.replace(Of, function(a, b, c) {
  ...
  tf.prototype.c = function(a) {
    return a.match(":host")
      ...
      : Mf(a.trim(), ":not(.style-scope)");
  };
  p.Object.defineProperties(tf.prototype, {
    a: {
      configurable: !0,
      enumerable: !0,
      get: function() {
  ...
  Sf.prototype._getStyleRules = Sf.prototype.c;
  function Uf(a) {
    var b =
      this.matches ||
  ...
  var Vf = navigator.userAgent.match("Trident");
  function Wf() {}
  function Xf(a) {
    var b = {},
      c = [],
  ...
  function Yf(a) {
    if (!a.i) {
      var b = {},
        c = {};
      Zf(a, c) && ((b.v = c), (a.rules = null));
      b.cssText = a.parsedCssText.replace(af, "").replace(Re, "");
      a.i = b;
    }
  }
  function Zf(a, b) {
  ...
  function $f(a, b, c) {
    b &&
      (b =
        0 <= b.indexOf(";")
          ? ag(a, b, c)
          : mf(b, function(b, e, f, g) {
              if (!e) return b + g;
              (e = $f(a, c[e], c)) && "initial" !== e
  ...
  function cg(a, b, c, d) {
    ...
    if (b.i.v) {
      ...
      if (g || h)
        (c = e),
          h &&
            (b.j || (b.j = Cf(R, b, R.b, a ? "." + a : "", e)), (c = b.j || e)),
          d({ ha: c, Ia: h, Za: g });
    }
  }
  function dg(a, b, c) {
    ...
    df(
      ...
      function(b) {
        cg(a, b, c, function(c) {
          Uf.call(a._element || a, c.ha) && (c.Ia ? Zf(b, d) : Zf(b, e));
        });
      },
      null,
      !0
  ...
  function eg(a, b, c, d) {
    ...
    return zf(
      ...
      function(b) {
        var e = "";
        b.i || Yf(b);
        b.i.cssText && (e = ag(a, b.i.cssText, c));
        b.cssText = e;
        if (!O && !ff(b) && b.cssText) {
          var h = (e = b.cssText);
          null == b.na && (b.na = Ue.test(e));
          if (b.na)
            if (null == b.U) {
              b.U = [];
              for (var l in k)
                (h = k[l]), (h = h(e)), e !== h && ((e = h), b.U.push(l));
            } else {
              for (l = 0; l < b.U.length; ++l) (h = k[b.U[l]]), (e = h(e));
              h = e;
            }
          b.cssText = h;
          b.j = b.j || b.selector;
          ...
          l = qf(b.j);
          h = 0;
          for (var M = l.length, U = void 0; h < M && (U = l[h]); h++)
            l[h] = U.match(g) ? U.replace(f, e) : e + " " + U;
          b.selector = l.join(",");
        }
      },
      h
  ...
  function hg(a, b) {
    var c = ig,
      d = ef(a);
    a.textContent = cf(d, function(a) {
      var d = (a.cssText = a.parsedCssText);
      a.i &&
        a.i.cssText &&
        ((d = d.replace(Ie, "").replace(Je, "")), (a.cssText = ag(c, d, b)));
    });
  }
  p.Object.defineProperties(Wf.prototype, {
    a: {
      configurable: !0,
      enumerable: !0,
      get: function() {
  ...
  function qg(a) {
    var b = of(a).getRootNode();
    return b === a || b === a.ownerDocument ? "" : (a = b.host) ? pf(a).is : "";
  }
  function rg(a) {
    for (var b = 0; b < a.length; b++) {
      var c = a[b];
  ...
  if (!(O || (window.ShadyDOM && window.ShadyDOM.handlesDynamicScoping))) {
    var sg = new MutationObserver(rg),
      tg = function(a) {
        sg.observe(a, { childList: !0, subtree: !0 });
      };
    if (
      window.customElements &&
      ...
      window.HTMLImports
        ? window.HTMLImports.whenReady(ug)
  ...
  n.prepareTemplateStyles = function(a, b, c) {
    if (!a._prepared && !Pe) {
      ...
      for (
        ...
        if (k.hasAttribute("shady-unscoped")) {
          if (!O) {
            var l = k.textContent;
            bf.has(l) ||
              (bf.add(l), (l = k.cloneNode(!0)), document.head.appendChild(l));
      ...
      if (!e) {
        if ((g = !d))
          (g = Se.test(f) || Re.test(f)),
            (Se.lastIndex = 0),
            (Re.lastIndex = 0);
        h = we(f);
        g && Q && this.a && this.a.transformRules(h, b);
        a._styleAst = h;
      }
      g = [];
      Q || (g = Xf(a._styleAst));
      if (!g.length || Q)
        (h = O ? a.content : null),
          (b = jg[b] || null),
          (d = zf(c, a._styleAst, null, d, e ? f : "")),
          (d = d.length ? gf(d, c.is, h, b) : null),
          (a._style = d);
      a.a = g;
    }
  };
  ...
  n.prepareTemplateDom = function(a, b) {
    if (!Pe) {
      ...
      O ||
        "shady" === c ||
        a._domPrepared ||
        ((a._domPrepared = !0), uf(a.content, b));
    }
  };
  function Eg(a) {
    var b = pf(a),
  ...
  function Dg(a) {
    !a.a &&
      ...
      ((a.a = window.ShadyCSS.ApplyShim), (a.a.invalidCallback = yg));
    Fg(a);
  }
  n.flushCustomStyles = function() {
    if (!Pe && (Dg(this), this.b)) {
      var a = this.b.processStyles();
      if (this.b.enqueued && !sf(this.f.cssBuild)) {
        if (Q) {
          if (!this.f.cssBuild)
            for (var b = 0; b < a.length; b++) {
          ...
          Gg(this, this.c, this.f);
          for (b = 0; b < a.length; b++)
            (c = this.b.getStyleForCustomStyle(a[b])) && hg(c, this.f.w);
  ...
  n.styleElement = function(a, b) {
    if (Pe) {
      ...
      if (
        ...
        Hg(this, a, c);
      else if ((this.flush(), Gg(this, a, c), c.fa && c.fa.length)) {
        b = pf(a).is;
        var d;
        a: {
          if ((d = Cg.cache[b]))
        ...
        e = c.s;
        (f = d && d.s) ||
          ((f = this.l[b] = (this.l[b] || 0) + 1), (f = b + "-" + f));
        c.s = f;
        f = c.s;
        h = ig;
        h = g ? g.textContent || "" : eg(h, a, c.w, f);
        k = T(a);
        var l = k.a;
        l &&
          !O &&
        ...
        O
          ? k.a
            ...
            : h && (g = gf(h, f, a.shadowRoot, k.b))
          : g
          ? g.parentNode ||
            (Vf && -1 < h.indexOf("@media") && (g.textContent = h),
            hf(g, null, k.b))
          : h && (g = gf(h, f, null, k.b));
        g &&
  ...
  function Hg(a, b, c) {
    ...
    if (
      ...
      if (zg(e) || e._applyShimValidatingVersion !== e._applyShimNextVersion)
        Dg(a),
          a.a && a.a.transformRules(e._styleAst, d),
          (e._style.textContent = zf(b, c.A)),
          Ag(e);
      O &&
        (a = b.shadowRoot) &&
        (a = a.querySelector("style")) &&
        (a.textContent = zf(b, c.A));
      c.A = e._styleAst;
    }
  }
  function Ig(a, b) {
    return (b = of(b).getRootNode().host)
      ? T(b) || Eg(b)
        ? b
        : Ig(a, b)
      : a.c;
  ...
  function Gg(a, b, c) {
    var d = Ig(a, b),
      e = T(d),
      f = e.w;
    d === a.c || f || (Gg(a, d, e), (f = e.w));
    a = Object.create(f || null);
    d = dg(b, c.A, c.cssBuild);
    b = bg(e.A, b).v;
    Object.assign(a, d.Ha, b, d.Ra);
    b = c.o;
    for (var g in b) if ((e = b[g]) || 0 === e) a[g] = e;
    g = ig;
    b = Object.getOwnPropertyNames(a);
    for (e = 0; e < b.length; e++) (d = b[e]), (a[d] = $f(g, a[d], a));
    c.w = a;
  }
    ...
    if (!sf(c)) {
      ...
      df(d, function(a) {
        if (O) Rf(a);
          ...
          Rf(a);
          a.selector = a.j = Cf(d, a, d.c, void 0, void 0);
        }
        Q && "" === c && (Dg(b), b.a && b.a.transformRule(a));
      });
      Q ? (a.textContent = cf(d)) : this.f.A.rules.push(d);
    }
  };
  n.getComputedStyleValue = function(a, b) {
    var c;
    Q || (c = (T(a) || T(Ig(this, a))).w[b]);
    return (c = c || window.getComputedStyle(a).getPropertyValue(b))
      ? c.trim()
      : "";
  };
  n.Ua = function(a, b) {
    var c = of(a).getRootNode();
    b = b ? b.split(/\s/) : [];
  ...
  Y.prototype.transformCustomStyleForDocument = Y.prototype.ra;
  ...
  Y.prototype.currentScopeForNode = Y.prototype.Da;
  ...
  var Z = new Y(),
    ...
    Kg;
  window.ShadyCSS &&
    ((Jg = window.ShadyCSS.ApplyShim),
    (Kg = window.ShadyCSS.CustomStyleInterface));
  window.ShadyCSS = {
    ScopingShim: Z,
  ...
  Jg && (window.ShadyCSS.ApplyShim = Jg);
  Kg && (window.ShadyCSS.CustomStyleInterface = Kg);
  var Lg = window.customElements,
    Mg = window.HTMLImports,
    Ng = window.HTMLTemplateElement;
  window.WebComponents = window.WebComponents || {};
  if (Lg && Lg.polyfillWrapFlushCallback) {
    var Og,
      Pg = function() {
        if (Og) {
          Ng.C && Ng.C(window.document);
          var a = Og;
          Og = null;
          a();
          return !0;
      ...
      Qg = Mg.whenReady;
    Lg.polyfillWrapFlushCallback(function(a) {
      Og = a;
      Qg(Pg);
    });
    Mg.whenReady = function(a) {
      Qg(function() {
        Pg() ? Mg.whenReady(a) : a();
      });
    };
  }
  Mg.whenReady(function() {
    requestAnimationFrame(function() {
  ...
  var Rg = document.createElement("style");
  Rg.textContent =
    "body {transition: opacity ease-in 0.2s; } \nbody[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; } \n";
  var Sg = document.querySelector("head");
  Sg.insertBefore(Rg, Sg.firstChild);
}.call(this));
