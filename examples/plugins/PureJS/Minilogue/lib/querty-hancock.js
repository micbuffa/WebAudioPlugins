...
(function () {
  ...
  var init = function (us,cont) {
      ...
      var container = cont.getElementById(settings.id);
  ...
  */
  ...
  var createKeyboard = function (cont) {
      var keyboard = {
          container: cont.getElementById(settings.id),
   ...
   */
  var QwertyHancock = function (settings,cont) {
